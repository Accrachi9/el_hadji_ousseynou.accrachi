...
Je combine enseignement universitaire, recherche scientifique, analyse de données institutionnelles et développement d’indicateurs pour l’évaluation d’impact.
...
👉 [Liste complète des publications](./publications.md)

---

## 📊 Projets & Analyse de données
Sélection de projets académiques et professionnels :  
👉 [Voir mes projets sur GitHub](https://github.com/Accrachi9/Accrachi9)
